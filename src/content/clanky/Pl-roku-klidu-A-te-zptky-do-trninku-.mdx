...
category: Aktuality
perex: 'Loňská sezóna byla z mého pohledu opravdu povedená. Jasně, hranice 3 hodin na Budapešťském maratonu nepadla, což byl hlavní cíl, ke kterému jsem dlouhodobě směřoval. Ale i když se to nepovedlo, nic to nemění na tom, že jsem měl po sezoně skvělý pocit. Běžecky jsem se posunul, tělo fungovalo, hlava držela a já měl hlavně jednu velkou výhodu: přesně jsem věděl, co musím zlepšit.'
cover: /images/hxqJjqXpA2NgqiQjaFQbWSDkXI.png
---
...
<ImageWrap image="/images/hxqJjqXpA2NgqiQjaFQbWSDkXI.png" align="left" />
...
<ImageWrap image="/images/hxqJjqXpA2NgqiQjaFQbWSDkXI.png" align="right" />
